...
const PLAYBACK_URL = "https://760b256a3da8.us-east-1.playback.live-video.net/api/video/v1/us-east-1.049054135175.channel.6tM2Z9kY16nH.m3u8";
...
const API_URL = "wss://edge.ivschat.us-east-1.amazonaws.com";
// Chat room id (ARN)
const CHAT_ROOM_ID = "arn:aws:ivschat:us-east-1:955228589631:room/yUc5M1gI0BxC";
...
export const LivestreamChat = () => {
    ...
    const tokenProvider = async (selectedUsername, isModerator, avatarUrl) => {
        ...
        // return token;
        return ({
            token: 'AQICAHgm5DC1V25pBVEhXdu--DOMvHAxl47LlIVxHqc_j6xXLgHu7Z4V5Kd-buMzhF9o71fLAAACITCCAh0GCSqGSIb3DQEHBqCCAg4wggIKAgEAMIICAwYJKoZIhvcNAQcBMB4GCWCGSAFlAwQBLjARBAyHbs4-J590JHUEUj4CARCAggHU41uYi99ZS5SMbOM9bDOD7VW2HKPhdvvPJ-zkdzd-FWdSGcxzNQjTp3P8DszVvK2OBERUHH_zgy4_Y0Y8i8ToWXwUOto6Tx3u5kth4-4YNmHWaRpebgV6NgJj8c3GQRNKNUAibJKuzgjx392e6blZkxYZZcuSjmg1VeThJjQ1TFnDsy4k8vbB7Ux_tC0gL62KD1Sl6_og_NZdHvbG7ifshUaUCVjRs6FZHEpef457l_RqZmKqZdNmqo9OeSfWa614jrju3NQkufPXWgl-ROoWygrWamKusFx9Pa5aHwjsnQ3VIjUkNDZMtZIfMfhGQJO1xlicySFbqkLOGZU9itCviiudUqRcx6ZmeAFhS8_luSp3eVf-pB7upVCbB8S2StAO66AYTPxx_u7xeUc9FuqTl2Fe_TAFliGGe7Nk8_9dpx-ekA5WEoWSXR62hvJvopbhHhRTSx-ne_F2S1ol2hD461RlBeAEHfAv8zKYXAxxS80zWxqlBCPicE-xVK4gFFPThDoug-PBo-8TwYAOvi9-1XcjD-zNXZY98LEf1SFGjHTbLCie_anW8_UlPywhXHYdGgP1fGsnRqIsv73R8nTZQzQv__a4Zk1a6YmhPRG9cVnjU2Lj#1',
